...
# nginx.conf
rm -fv /root/release/release-image/release-service/manager/vemerge/etc/nginx/nginx.conf
cp /root/develop/xlauncher/src/server/conf/nginx.conf /root/release/release-image/release-service/manager/vemerge/etc/nginx/nginx.conf
